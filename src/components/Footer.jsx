...
const Footer = () => {
  const socialLinks = [
    ...
    {
      name: "GitHub",
      url: "https://github.com/nabeelijaz",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer id="contact" className="bg-gradient-to-r from-gray-900 to-blue-900 text-white py-12"> {/* Added id="contact" here */}
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h3 className="text-xl font-bold mb-6 text-center text-white">Follow My Journey</h3>
            <div className="flex justify-center space-x-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="bg-white/10 p-4 rounded-xl hover:bg-blue-600 transition-all duration-300 transform hover:scale-110 hover:shadow-lg border border-white/20"
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © {new Date().getFullYear()} Nabeel Ijaz. Crafted with passion and modern technologies.
          </p>
