    ...
    <footer id="contact" className="text-white py-16 relative overflow-hidden border-t border-white/10" style={{ background: 'var(--footer-bg)' }}>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'} text-center md:text-left`}>
            ...
            <div className="mt-6 flex flex-col md:flex-row items-center md:items-start flex-wrap gap-4 justify-center md:justify-start">
